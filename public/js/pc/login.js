$(function(){
    ...
    function showTips(content){
        $('.error-remind').css('display','block').html(content).fadeOut(2000,'linear');
        return true;
    }
    ...
    //获取验证码+倒计时
    $('.security-get-btn').on('click', function() {
    ...
    $('.forget-psw-btn').on('click',function() {
        toForgetPsw();
    });
    ...
    $('.login-psw-btn').on('click', function() {
        toPswLogin();
    });
    ...
    $('.login-security-btn').on('click', function() { //验证码登录
        toSecurityLogin();
    });
    ...
    $('.change-phone-btn').on('click', function() { //更换手机
        toChangePhone();
    });
    ...
    $('.register-email-btn').on('click', function() {
        toRegisterEmail();
    });
    ...
    $('.register-username-btn').on('click', function() {
        toRegisterUsername()
    });
