...
<body>
    ...
    <div class="content-one">
        ...
        <div class="input_base input-security">
            <p>验证码</p>
            <input type="text" class="security" placeholder="验证码" />
            <label class="security-get-btn">获取验证码</label>
            <label class="security-time-btn">60秒</label>
        </div>
        <button class="btn_sbm login-security-btn">登录</button>
        <div class="link-login-user">
            <a href="{!! $data['loginURL'] !!}">切换成账号登录</a>
        </div>
